...
# with command line options: Configuration/Generator/python/BBbar_Jpsi_Phi_Filter_HardQCD_10_ptHook_cfi --conditions auto:phase1_2018_realistic --era Run2_2018 --beamspot Realistic25ns13TeVEarly2018Collision -s GEN,SIM --eventcontent RAWSIM --datatier GEN-SIM --no_exec --python_filename BBbar_Jpsi_Phi_Filter_HardQCD_10_ptHook_GEN_SIM.py
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('BBbar_JpsiFilter_HardQCD_GEN_SIM.root'),
