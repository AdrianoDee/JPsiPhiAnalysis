...
# with command line options: BBbar_Jpsi_Phi_Filter_HardQCD_10_cfg.py --conditions auto:phase1_2018_realistic --era Run2_2018 --beamspot Realistic25ns13TeVEarly2018Collision -s GEN,SIM --eventcontent RAWSIM --datatier GEN-SIM --no_exec --python_filename BBbar_JpsiFilter_HardQCD_20.py
...
process.kkgenfilter = cms.EDFilter("MCParticlePairFilter",
