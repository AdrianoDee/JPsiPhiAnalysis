...
boost_header_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/boost/1.63.0-omkpbe4/include
...
boost_python_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/boost/1.63.0-omkpbe4/include
...
ALL_TOOLS      += cgal
cgal_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/cgal/4.2-gnimlf/include
...
ALL_TOOLS      += cub
cub_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/cub/1.8.0-gnimlf2/include
cub_EX_USE := cuda

ALL_TOOLS      += cuda-api-wrappers
cuda-api-wrappers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/cuda-api-wrappers/20180504-gnimlf2/include
...
ALL_TOOLS      += cuda
ALL_LIB_TYPES += CUDA_LIB
cuda_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/cuda/9.2.88-gnimlf/include
...
cuda-stubs_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/cuda/9.2.88-gnimlf/include
cuda-stubs_EX_LIB := cuda
cuda-stubs_EX_LIBDIR := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/cuda/9.2.88-gnimlf/lib64/stubs
...
ALL_TOOLS      += dd4hep
dd4hep_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/dd4hep/v01-08x-gnimlf/include
...
ALL_TOOLS      += herwigpp
herwigpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/herwigpp/7.1.2-gnimlf7/include
...
ALL_TOOLS      += llvm
llvm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/llvm/6.0.0-gnimlf2/include
llvm_EX_LIB := clang
...
ALL_TOOLS      += lwtnn
lwtnn_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/lwtnn/2.4-gnimlf3/include
lwtnn_EX_LIB := lwtnn
...
mxnet-predict_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/mxnet-predict/1.2.0-gnimlf/include
...
ALL_TOOLS      += openmpi
openmpi_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/openmpi/2.1.2rc4-omkpbe2/include
...
ALL_TOOLS      += sherpa
sherpa_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/sherpa/2.2.4-gnimlf6/include/SHERPA-MC
...
ALL_TOOLS      += thepeg
thepeg_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/thepeg/2.1.1-gnimlf6/include
thepeg_EX_LIB := ThePEG LesHouches
thepeg_EX_USE := root_cxxdefaults lhapdf gsl

ALL_TOOLS      += tinyxml
tinyxml_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/tinyxml/2.5.3-omkpbe4/include
...
ALL_TOOLS      += utm
utm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/utm/utm_0.6.7/include
...
ALL_TOOLS      += yaml-cpp
yaml-cpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/yaml-cpp/0.6.2/include
