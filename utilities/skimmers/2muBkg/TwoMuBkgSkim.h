...
// Thu Mar  8 11:59:34 2018 by ROOT version 6.10/09
// from TTree JPsi Bkg Tree/Tree of DiMuon and DiTrak
// found on file: /lustre/cms/store/user/adiflori/Charmonium/crab_miniaod_2muBkg_Charmonium_Run2017B-17Nov2017-v1_MINIAOD___20180221_182803/merge.root
//////////////////////////////////////////////////////////

#ifndef TwoMuBkgSkim_h
#define TwoMuBkgSkim_h
...
class TwoMuBkgSkim : public TSelector {
public :
   ...
   TwoMuBkgSkim(TTree * /*tree*/ =0) { }
   virtual ~TwoMuBkgSkim() { }
   ...
   ClassDef(TwoMuBkgSkim,0);

};

#endif

#ifdef TwoMuBkgSkim_cxx
void TwoMuBkgSkim::Init(TTree *tree)
{
