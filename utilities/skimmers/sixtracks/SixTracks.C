...
void SixTracks::SlaveBegin(TTree * /*tree*/)
{
  ...
  outTree->Branch("dimuonDiTrkFive_mmpp", 	&out_dimuonDiTrkFive_mmpp, 	"dimuonDiTrkFive_mmpp/F");
  outTree->Branch("dimuonDiTrkSix_mmpp", 	&out_dimuonDiTrkSix_mmpp, 	"dimuonDiTrkSix_mmpp/F");
  ...
  outTree->Branch("dimuonDiTrkFive_mmkk", 	&out_dimuonDiTrkFive_mmkk, 	"dimuonDiTrkFive_mmkk/F");
  outTree->Branch("dimuonDiTrkSix_mmkk", 	&out_dimuonDiTrkSix_mmkk, 	"dimuonDiTrkSix_mmkk/F");
