...
config.General.requestName      = 'miniaod_2mupik_' + dataset[0]+'_'+dataset[1]+'_'+dataset[2]+'_'+runNum+'_'+timestamp #+'_split_'+ jsonFile.split('_')[-1].split('.')[0]
config.General.transferLogs     = False

config.section_('JobType')
config.JobType.psetName         = '/lustre/home/adrianodif/jpsiphi/2016/CMSSW_9_4_0/src/jpsiphi/jpsiphi/test/run-2mupik-miniaod.py'
