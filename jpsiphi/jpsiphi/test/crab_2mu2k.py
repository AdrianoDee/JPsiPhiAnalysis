...
"BBbar_OfficialMC_2018" : "/BToJpsi_ToMuMu_BMuonFilter_HardQCD_TuneCP5_13TeV-pythia8-evtgen/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM"
}
...
GlobalTags = {
    ...
    "BBbar_OfficialMC_2018"   :   "102X_upgrade2018_realistic_v15"
...
config.JobType.pyCfgParams      = ['gtag=' + str(gtag), 'dataset=' + str(run), 'isSix=' + str(six),'isFive=' + str(five), 'isMC=' + str(isMC)]
...
config.Debug.scheddName = 'crab3@vocms0194.cern.ch'
