...
private:
  ...
  Double_t highKaonMuonDR, highKaonMuonDP, highKaonMuonDPt, lowKaonMuonDR, lowKaonMuonDP, lowKaonMuonDPt;
...
TreeName_(iConfig.getParameter<std::string>("TreeName"))
{
  ...
  if(!OnlyGen_)
  {
    ...
    dimuonditrk_tree->Branch("highKaonMuonDPt",        &highKaonMuonDPt,        "highKaonMuonDPt/D");
    ...
    dimuonditrk_tree->Branch("lowKaonMuonDPt",        &lowKaonMuonDPt,        "lowKaonMuonDPt/D");
  ...
  if(!OnlyGen_)
  {
    if (!dimuonditrk_cand_handle.isValid()) std::cout<< "No dimuontt information " << run << "," << event <<std::endl;
      ...
      for (unsigned int i=0; i< dimuonditrk_cand_handle->size(); i++){
        ...
        highKaonMuonDPt = dimuonditrk_cand.userFloat("highKaonMuonDPt");
        lowKaonMuonDR  = dimuonditrk_cand.userFloat("lowKaonMuonDR");
        lowKaonMuonDP  = dimuonditrk_cand.userFloat("lowKaonMuonDP");
        lowKaonMuonDPt  = dimuonditrk_cand.userFloat("lowKaonMuonDPt");
