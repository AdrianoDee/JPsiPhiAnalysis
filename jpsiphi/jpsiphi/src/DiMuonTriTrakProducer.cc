// #include "../interface/DiMuonTriTrakProducer.h"
//
//
// float DiMuonTriTrakProducer::DeltaR(const pat::PackedCandidate t1, const pat::TriggerObjectStandAlone t2)
// {
//    float p1 = t1.phi();
//    float p2 = t2.phi();
//    float e1 = t1.eta();
...
// }
//
// float DiMuonTriTrakProducer::DeltaPt(const pat::PackedCandidate t1, const pat::TriggerObjectStandAlone t2)
// {
//    return (fabs(t1.pt()-t2.pt())/t2.pt());
// }
//
// bool DiMuonTriTrakProducer::MatchByDRDPt(const pat::PackedCandidate t1, const pat::TriggerObjectStandAlone t2)
// {
...
//
// bool
// DiMuonTriTrakProducer::isAbHadron(int pdgID) {
//
...
//
// bool
// DiMuonTriTrakProducer::isAMixedbHadron(int pdgID, int momPdgID) {
//
...
//
// bool
// DiMuonTriTrakProducer::isTheCandidate(reco::GenParticleRef genY) {
//
//   bool goToJPsi = false;
//   bool goToPhi = false;
//
...
// }
//
// bool DiMuonTriTrakProducer::isSameTrack(reco::Track t1, reco::Track t2)
// {
//
//   float p1 = t1.phi();
//   float p2 = t2.phi();
...
// DiMuonTriTrakProducer::findJpsiMCInfo(reco::GenParticleRef genJpsi) {
//
...
// }
//
// const pat::CompositeCandidate DiMuonTriTrakProducer::makeTTTriggerCandidate(
...
// }
//
// const pat::CompositeCandidate DiMuonTriTrakProducer::makeTTTriggerMixedCandidate(
...
// }
//
// DiMuonTriTrakProducer::DiMuonTriTrakProducer(const edm::ParameterSet& iConfig):
...
// }
//
// void DiMuonTriTrakProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup){
//
//   // int debug = 1;
//
...
//
//            for (size_t k = jstart; k < trak->size(); k++)
//            {
//              auto thirdTrack = trak->at(k);
//
//              //if(!addSameSig_ && negTrack.charge()>=0) continue;
//              if(thirdTrack.pt()<trakPtCut_) continue;
//
...
// }
//
// void DiMuonTriTrakProducer::endJob(){
//   std::cout << "#########################################" << std::endl;
...
// }
//
// bool DiMuonTriTrakProducer::IsTheSame(const pat::PackedCandidate& tk, const pat::Muon& mu){
...
// }
//
// pat::CompositeCandidate DiMuonTriTrakProducer::makeDiMuonTTCandidate(
...
// }
//
// pat::CompositeCandidate DiMuonTriTrakProducer::makeDiMuonTriCand(
//                                           const pat::CompositeCandidate& dimuontt,
// 				          const pat::PackedCandidate& thirdTrack
//                                          ){
//
//   pat::CompositeCandidate DiMuonTCand;
//   DiMuonTCand.addDaughter(dimuon,"dimuon");
...
// }
//
// pat::CompositeCandidate DiMuonTriTrakProducer::makeTTCandidate(
//                                           const pat::PackedCandidate& highTrak,
...
//
//
// reco::Candidate::LorentzVector DiMuonTriTrakProducer::convertVector(const math::XYZTLorentzVectorF& v){
//
//   return reco::Candidate::LorentzVector(v.x(),v.y(), v.z(), v.t());
// }
// //define this as a plug-in
// DEFINE_FWK_MODULE(DiMuonTriTrakProducer);
