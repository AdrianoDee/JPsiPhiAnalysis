...
DoubleDiMuonProducerFit::findJpsiMCInfo(reco::GenParticleRef genJpsi) {
...
void DoubleDiMuonProducerFit::endJob(){
  std::cout << "###########################" << std::endl;
...
reco::Candidate::LorentzVector DoubleDiMuonProducerFit::convertVector(const math::XYZTLorentzVectorF& v){

  return reco::Candidate::LorentzVector(v.x(),v.y(), v.z(), v.t());
}
//define this as a plug-in
DEFINE_FWK_MODULE(DoubleDiMuonProducerFit);
