...
#ifndef _DiMuonDiTrakProducerPAT_h
#define _DiMuonDiTrakProducerPAT_h
...
class DiMuonDiTrakProducerPAT : public edm::EDProducer {
public:
  explicit DiMuonDiTrakProducerPAT(const edm::ParameterSet&);
  ~DiMuonDiTrakProducerPAT();
...
// rsync -vut --existing interface/MuMuPiKPAT.h semrat@lxplus.cern.ch:/afs/cern.ch/user/s/semrat/scratch0/CMSSW_5_3_22/src/X4140/DiMuonDiTrakProducerPAT/interface/MuMuPiKPAT.h
